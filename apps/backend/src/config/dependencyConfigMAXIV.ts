...
import { configureMAXIVDevelopmentEnvironment } from './maxiv/configureMAXIVEnvironment';
...
mapValue(Tokens.EmailEventHandler, maxivEmailHandler);
...
mapValue(
  ...
  isProduction ? () => {} : configureMAXIVDevelopmentEnvironment
);

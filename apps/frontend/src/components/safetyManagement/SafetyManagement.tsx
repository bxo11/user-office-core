...
type ExternalReviewsProps = {
  proposalSafetyComments: any[] | null;
};

const SafetyManagement = ({ proposalSafetyComments }: ExternalReviewsProps) => {
        ...
        <TableContainer>
          <Table className={classes.table}>
            <TableBody>
              ...
              {proposalSafetyComments?.map((review) => (
...
SafetyManagement.propTypes = {
  proposalSafetyComments: PropTypes.array,
};
